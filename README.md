...
**[terraform-k8s-argocd-cicd-pipeline](https://github.com/didiberman/terraform-k8s-argocd-cicd-pipeline)** - Kubernetes deployment pipeline with ArgoCD and Terraform. Built with HCL (60.5%), JavaScript (34.8%), and Dockerfile (4.7%).
