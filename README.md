...
| Project | Description |
|---|---|
| **[practical-aks](https://github.com/didiberman/practical-aks)** | Guided AKS build: blank Azure subscription → Workload Identity-secured, Trivy-scanned cluster running a live LLM proxy. CI/CD pipeline includes supply chain hardening: SHA-pinned Actions and `harden-runner` network egress control. |
