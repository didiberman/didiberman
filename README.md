...
| **[didiberman.com](https://github.com/didiberman/didiberman-portfolio)** | This portfolio site. React + Vite + TypeScript, shipped to AWS S3/CloudFront via GitHub Actions with OIDC-based auth (no static AWS credentials in CI).<br/>![React](https://img.shields.io/badge/React-61DAFB?style=flat-square&logo=react&logoColor=black) ![Vite](https://img.shields.io/badge/Vite-646CFF?style=flat-square&logo=vite&logoColor=white) ![TypeScript](https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=white) ![AWS](https://img.shields.io/badge/AWS-CloudFront-FF9900?style=flat-square&logo=amazonaws&logoColor=white) |
